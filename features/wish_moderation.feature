...
Feature: Wish Moderation
  ...
  Background:
    ...
    And I am logged in as "joe-the-mod" with role "mod"
  ...
  Scenario: Rejecting a wish filling
    ...
    And a new system message with subject "request filling rejected" should be received by "joe-the-filler"
  ...
  Scenario: Approving a wish filling with bounty transfer
    ...
    And a new system message with subject "your request was filled" should be received by "joe-the-wisher"
    And a new system message with subject "request filling approved" should be received by "joe-the-filler"
    And a new system message with subject "request filled" should be received by "joe-the-bounter"
